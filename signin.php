    ...
    <main>
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <form method="POST" class="col-md-6 col-12 col-sm-6  col-lg-5 m-auto login-css" action="auth.php">
                    ...
                    <div class="mb-4">
                        <label for="mail" class="form-label">Votre Email <span>*</span></label>
                        <input type="email" class="form-control" placeholder="welcome@gmail.com" name="email">
                    </div>

                    <div class="mb-4">
                        <label for="mail" class="form-label">Mot de passe <span>*</span></label>
                        <input type="password" class="form-control" placeholder="*****" name="pwd">
                        <small class="text-dark bg-danger"></small>
                    </div>

                    <div class="">
                        <button class="btn btn-lg roounded-0 w-100 btn-primary mt-4" type="submit" name="send">S'inscire</button>
                    </div>
                    <div>
                        <small class="muted" style="flex-wrap:nowrap;">Déjà un compte ? <a href="./login.php" class="">Connectez-vous</a></small>
                    </div>
                </form>
            </div>
        </div>
